				...
				<div class="card-body container-fluid">
					<form method="post" action="purchase.php" class="form-horizontal">
						...
						<div class="mb-3">
							...
							<input type="hidden" name="id" value="<?php echo $_SESSION['id'];?>" class="form-control rounded-0">
							<input type="hidden" name="name" value="<?php echo $_SESSION['name'];?>" class="form-control rounded-0">
